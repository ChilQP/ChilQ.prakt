...
public class task_model {
    ...
    public task_model(String name_task, String desc_task , String date_complete,  String pic_task, String pic_compl_task, int reward, String date_rec, int task_compl, String name_child){
