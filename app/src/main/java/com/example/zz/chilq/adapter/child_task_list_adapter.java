...
public class child_task_list_adapter extends RecyclerView.Adapter<child_task_recycler_view_holder> {
    ...
    @Override
    public child_task_recycler_view_holder onCreateViewHolder(ViewGroup parent,
                                                              int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_child_tasks_card_view, parent, false);
        child_task_recycler_view_holder vh = new child_task_recycler_view_holder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(final child_task_recycler_view_holder holder, final int position) {
        ...
        holder.mFailedButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        holder.mCompletedButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View view) {
