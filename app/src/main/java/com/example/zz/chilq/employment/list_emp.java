...
public class list_emp extends Fragment {
    ...
    private DatabaseReference myRef,taskRef,idRef;
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        myRef = FirebaseDatabase.getInstance().getReference().child("Child").child(encodeForFirebaseKey(user.getEmail())).child("Parent");
        ...
        if (mChildEventListener == null) {
            mChildEventListener = new ChildEventListener() {
                ...
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    ...
                    taskRef.orderByChild("name_parent").equalTo(dataSnapshot.getValue().toString()).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
